           ...
           steps{
                ...
                script {
                    ...
                    withSonarQubeEnv('Sonar Server') {
                      sh "${scannerHome}/bin/sonar-scanner -Dsonar.projectKey=tarea4 -Dsonar.java.binaries=target/ -Dsonar.host.url=http://172.18.0.4:9000 -Dsonar.login=a88b33c57bb008dc2ad992f81ae8bef451fd5a95"
                    }
                }
           }
        }
